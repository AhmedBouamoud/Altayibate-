        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-5">
              ...
              <span className="text-lg font-extrabold text-white">نظام الطيبات</span>
            </Link>
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mb-4 leading-relaxed">
              اشترك واحصل على أحدث المقالات والنصائح الصحية مباشرة إلى بريدك أسبوعياً.
            </p>
            <form className="space-y-2">
              <input
                type="email"
                placeholder="بريدك الإلكتروني"
                className="w-full px-4 py-2.5 rounded-xl bg-gray-900 text-white placeholder-gray-600 border border-gray-800 focus:outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-600 transition-all text-sm"
              />
              <button
                type="submit"
                className="w-full bg-primary-600 text-white py-2.5 rounded-xl hover:bg-primary-500 transition-colors text-sm font-semibold shadow-green"
              >
                اشترك مجاناً
              </button>
            </form>
      ...
      <div className="border-t border-gray-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-gray-600 text-xs">
            © {new Date().getFullYear()} نظام الطيبات. جميع الحقوق محفوظة.
          </p>
